...
def get_layout(content):
    ...
    ''' if is_logged else '<a href="/login" style="text-decoration:none; color:var(--primary); font-weight:bold;">دخول</a>'
...
def index():
    ...
    '''
    return get_layout(f'<div class="grid">{cards}</div>{modal}')
...
def login():
    ...
    return get_layout('<div style="text-align:center; padding:50px;"><form method="post">966+ <input type="number" name="phone" required><input type="password" name="password" required><button type="submit">دخول</button></form></div>')
...
def register():
    ...
    return get_layout('<div style="text-align:center; padding:50px;"><form method="post">966+ <input type="number" name="phone" required><input type="password" name="password" required><button type="submit">التالي</button></form></div>')
...
def verify():
    ...
    return get_layout(f'<div style="text-align:center; padding:50px;"><a href="{wa}" target="_blank" style="background:green; color:white; padding:10px; text-decoration:none;">طلب الكود</a><form method="post"><input type="number" name="otp" required><button type="submit">تأكيد</button></form></div>')
...
def my_ads():
    ...
    return get_layout(f'<div class="grid">{cards}</div>')
