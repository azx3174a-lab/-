...
app = Flask(__name__)
app.secret_key = "eyin_secure_market_v16" # مفتاح التشفير للرسائل
...
def index():
    ...
    if request.method == 'POST' and request.form.get('action') == 'delete':
        ...
        if result and result['delete_code'] == user_code:
            ...
            flash('❌ الكود السري غير صحيح، حاول مرة أخرى', 'error')
    ...
    <head>
        ...
        <title>متجر عين - منصة العرض</title>
        <style>
            ...
            .delete-input { font-size: 12px; padding: 5px; margin: 0; border: 1px solid #ef4444; border-radius: 5px; width: 100%; }
        ...
        <div id="addModal" class="modal">
            <div class="modal-content">
                ...
                <form action="/add_public" method="post" enctype="multipart/form-data">
                    ...
                    <input type="password" name="delete_code" placeholder="كود سري لحذف الإعلان" required>
                    <label style="font-size: 12px;">صورة المنتج:</label>
